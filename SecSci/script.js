...
const repositories = [
    ...
    {
        name: "Gas Tests Experiment",
        description: "Interactive virtual laboratory for learning how to test for the presence of oxygen (glowing splint, burning splint), carbon dioxide (lime water, hydrogencarbonate indicator), and water vapour (dry cobalt chloride paper). Select different gases and observe the test results with visual animations.",
        icon: "🧪",
        url: "gas_tests/",
        branch: "SecSci",
        tags: ["chemistry", "gas tests", "oxygen", "carbon dioxide", "water vapour", "interactive", "education"],
        status: "active"
    },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Repositories:', repositories.map(r => r.name));
    initializePortal();
    setupSearch();
});
...
// Version: 2025-01-23 - Added Gas Tests Experiment
